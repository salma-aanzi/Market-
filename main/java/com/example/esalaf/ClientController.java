...
public class ClientController implements Initializable {
    ...
    protected void onSaveButtonClick(){
        Client cli = new Client(0, nom.getText() , tele.getText() , cin.getText());
        try {
    ...
    protected void onDeleteButtonClick() {
        Client cli = new Client((int) Integer.parseInt(ido.getText()), nom.getText(), tele.getText(), cin.getText());
        try {
            ClientDAO clidao = new ClientDAO();
            clidao.delete(cli);
        } catch (SQLException e) {
